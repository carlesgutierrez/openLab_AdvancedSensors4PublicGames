...
demoParticle::demoParticle(){
	...
	myAttracPos_ModeAtract = ofPoint(ofGetWidth()*0.5, ofGetHeight()*0.5);
}
...
void demoParticle::update(){
	...
	if( mode == PARTICLE_MODE_ATTRACT ){
		...
		//TODO set here the point form TRIGOInteraction
		ofPoint attractPt(myAttracPos_ModeAtract.x, myAttracPos_ModeAtract.y);
...
//------------------------------------------------------------------
void demoParticle::setAttracPos_ModeAtract(ofPoint _pto){
	myAttracPos_ModeAtract = _pto;
}

//---------------------------------------
ofPoint demoParticle::getAttracPos_ModeAtract(){
	return myAttracPos_ModeAtract;
}
