...
void ImGui::NewFrame()
{
	...
	//{c} added WasDraggin Functionality
	g.IO.bWasDragging = g.IO.bDragging;//copoy last value
	g.IO.bDragging = false;//clean drag status
...
bool ImGui::WasDragging()
{
	ImGuiState& g = *GImGui;
	return g.IO.bWasDragging;
}
...
bool ImGui::IsMouseDragging(int button, float lock_threshold)
{
	...
	g.IO.bDragging = g.IO.MouseDragMaxDistanceSqr[button] >= lock_threshold * lock_threshold;//{c}added functionality
    return g.IO.bDragging;
}
